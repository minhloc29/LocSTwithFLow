# source: https://github.com/prov-gigapath/prov-gigapath/blob/main/gigapath/slide_encoder.py
...
from gigapath.torchscale.model.LongNet import make_longnet_from_name
