...
python stflow/app/hest/benchmark.py --datasets COAD --encoders uni_v1_official --weights_root dataset/weights_root --source_dataroot dataset --embed_dataroot dataset --batch_size 128
